 ...
 */
class FrameStage extends SymmetricPipelineStage[HasConnectionInfo, Frame, ByteString] {

  override def apply(ctx: HasConnectionInfo): PipePair[Frame, ByteString, Frame, ByteString] = new SymmetricPipePair[Frame, ByteString] {
