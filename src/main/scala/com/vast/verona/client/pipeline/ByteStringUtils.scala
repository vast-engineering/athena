 ...
 *
 */
private[verona] object ByteStringUtils {
  ...
  def readConsistency(it: ByteIterator)(implicit byteOrder: ByteOrder): Consistency = {
    ...
    Consistency.fromId(consistencyCode).getOrElse(throw new InternalException(s"Unknown consistency value $consistencyCode"))
  }
